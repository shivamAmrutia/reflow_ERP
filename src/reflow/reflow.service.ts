import {
  ...
  export function reflowSchedule(
    ...
    for (const order of ordered) {
      ...
      // Dependency constraint: cannot start before parents end.
      ...
      // Work center constraint: avoid timeline overlap.
      ...
      // Record change.
      if (start.getTime() !== order.start.getTime()) {
        changes.push({
          workOrderId: order.id,
          oldStart: order.start,
          newStart: start,
